...
/**
 ...
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions-interpolate"><code>interpolate</code></a>
...
/**
 ...
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions">Mapbox Style Specification</a>.
 */
...
/**
 ...
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions-zoom"><code>zoom</code></a>
 expression operator in the Mapbox Style Specification.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions-heatmap-density"><code>heatmap-density</code></a>
 expression operator in the Mapbox Style Specification.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions-line-progress"><code>line-progress</code></a>
 expression operator in the Mapbox Style Specification.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#eexpressions-geometry-type"><code>geometry-type</code></a>
 expression operator in the Mapbox Style Specification.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions-id"><code>id</code></a>
 expression operator in the Mapbox Style Specification.
 */
...
/**
 `NSExpression` variable that corresponds to the
 <a href="https://track-asia.com/trackasia-gl-js-docs/style-spec/#expressions-properties"><code>properties</code></a>
 expression operator in the Mapbox Style Specification.
 */
