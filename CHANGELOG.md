...
* Updated TrackAsia Native dependency to ios-v6.0.0 (https://github.com/track-asia/trackasia-native/releases/tag/ios-v6.0.0). Implementers need to change the prefix MGL to MLN for all TrackAsia Native classes that are referenced.
